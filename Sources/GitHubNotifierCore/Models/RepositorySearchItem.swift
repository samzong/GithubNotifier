...
//  GitHubNotifierCore
//
//  Repository item returned from GitHub Search API.
//

import Foundation

/// Represents a repository returned from GitHub GraphQL search.
/// Used by SearchService to display repository search results.
